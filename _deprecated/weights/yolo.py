...
class Detect(nn.Module):
    ...
    def forward(self, x):
        ...
        dbox = dist2bbox(self.dfl(box), self.anchors.unsqueeze(0), xywh=True, dim=0) * self.strides
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            ...
            Bottleneck, SPP, SPPF,  BottleneckCSP, nn.ConvTranspose2d, DWConvTranspose2d, SPPCSPC, ADown,
            RepNCSPELAN4, SPPELAN, h_sigmoid, h_swish, SELayer, conv_bn_hswish, CoordAtt, DP_RepNCSPELAN4}:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov9_dw.yaml', help='model.yaml')
